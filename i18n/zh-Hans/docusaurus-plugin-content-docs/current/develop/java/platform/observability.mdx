...
在 Workflow 代码中，您可以使用动态添加 Update 或 Search Attribute [`upsertTypedSearchAttributes`](https://www.javadoc.io/doc/io.Temporal/Temporal-sdk/latest/io/Temporal/Workflow/Workflow.html#upsertTypedSearchAttributes(io.Temporal.common.SearchAttributeUpdate...))。
