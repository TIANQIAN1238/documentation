---
id: event-history-python
title: Event History walkthrough with the Python SDK
description: Discover how Temporal uses the Event History to recreate a Workflow's state in the case of failure, such as a Worker
